...
def train() -> None:
    ENV: PLE = PLE(Pixelcopter(width=Globals.GAME_WIDTH, height=Globals.GAME_HEIGHT), fps=30,
    ...
    while not ENV.game_over():
        ...
        Artist.show_image(PixelCopterImagePreprocessor.preprocess_image(state, requires_grad=False))
